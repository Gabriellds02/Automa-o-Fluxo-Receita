...
class BaseDados:
    ...
    def __init__(self):
        self.principal = Path(r'I:\Meu Drive\Prestação de Contas\Prestação de Contas FMAS (Geral)\2018\Detalhamento da Receita')
        self.csv_files = glob.glob(os.path.join(self.principal, "*.csv"))
        self.caminho_backup = pathlib.Path(r'I:\Meu Drive\Prestação de Contas\Prestação de Contas FMAS (Geral)\2018\Detalhamento da Receita')
